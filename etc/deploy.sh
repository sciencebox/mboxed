...
install_charts() {
  helm upgrade --install \
    ...
    --set cernbox.authproviderbearer.oidc.insecure=true \
    --set cernbox.authproviderbearer.oidc.issuer="https://${HOSTNAME}" \
    --set cernbox.authproviderbearer.oidc.id_claim="name" \
    --set cernbox.authproviderbearer.oidc.uid_claim="uid" \
    --set cernbox.authproviderbearer.oidc.gid_claim="gid" \
